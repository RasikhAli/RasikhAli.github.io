    ...
    <div className="min-h-screen bg-neutral-950 text-white py-16 selection:bg-indigo-500/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="flex gap-2">
              ...
              <select
                ...
                className="px-4 py-2.5 bg-neutral-900 border border-neutral-800 rounded-lg text-sm text-neutral-300 focus:outline-none focus:border-indigo-500 transition-colors"
              >
          ...
          {showFilters && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-5 bg-neutral-900/40 border border-neutral-850 rounded-xl backdrop-blur-md animate-in slide-in-from-top-4 duration-200">
              {/* Developer Filter */}
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-neutral-450 uppercase tracking-wider">Developer</label>
                <select
              ...
              <div className="col-span-2 md:col-span-4 flex justify-end">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-neutral-400 hover:text-white transition-colors"
                >
        ...
        {filteredProjects.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 border border-dashed border-neutral-850 rounded-xl bg-neutral-900/10">
            ...
            <h3 className="text-base font-bold text-neutral-350">No projects found</h3>
            ...
            <button
              onClick={resetFilters}
              className="mt-6 px-4 py-2 bg-neutral-900 border border-neutral-800 text-sm font-semibold rounded-lg hover:bg-neutral-850 text-neutral-300 hover:text-white transition-all"
            >
              Reset Filters
            </button>
          </div>
